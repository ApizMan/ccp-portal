                ...
                <form class="mx-5 my-5"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="status" name="status">
                            ...
                            <option value="completed" @if ($data['transaction']['status']=='completed' ) selected
                                @endif>Completed
                            </option>
                            <option value="pending" @if ($data['transaction']['status']=='pending' ) selected @endif>
                                Pending</option>
                            <option value="cenceled" @if ($data['transaction']['status']=='canceled' ) selected @endif>
                                Canceled</option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="amount" class="form-control" id="amount"
                            value="{{ number_format($data['transaction']['amount'], 2) }}" min="0" step="0.01">
                    </div>

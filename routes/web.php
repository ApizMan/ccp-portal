...
use App\Http\Controllers\PromotionCompoundController;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('promotion')
        ...
        ->group(function () {
            ...
            Route::prefix('compound')
                ->name('compound.')
                ->group(function () {
                    // View Promotion Compound
                    Route::get('/compound', [PromotionCompoundController::class, 'index'])->name(name: 'compound');
                    Route::get('/view/{id}', [PromotionCompoundController::class, 'view'])->name(name: 'compound_view');

                    Route::get('/create', [PromotionCompoundController::class, 'create'])->name('compound_create');
                    Route::post('/store', [PromotionCompoundController::class, 'store'])->name('compound_store');

                    // Edit Promotion
                    Route::get('/{id}', [PromotionCompoundController::class, 'edit'])->name(name: 'compound_edit');
                    Route::put('/update/{id}', [PromotionCompoundController::class, 'update'])->name(name: 'compound_update');

                    // Delete Promotion
                    Route::delete('/delete/{id}', [PromotionCompoundController::class, 'destroy'])->name(name: 'compound_delete');
                });
        });
